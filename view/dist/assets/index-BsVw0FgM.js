...
`)+`
`+f,p=["#define varying in",t.glslVersion===Aa?"":"layout(location = 0) out highp vec4 pc_fragColor;",t.glslVersion===Aa?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+p);const S=T+f+a,E=T+p+o,H=oo(r,r.VERTEX_SHADER,S),R=oo(r,r.FRAGMENT_SHADER,E);r.attachShader(_,H),r.attachShader(_,R),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function A(C){if(i.debug.checkShaderErrors){const B=r.getProgramInfoLog(_).trim(),L=r.getShaderInfoLog(H).trim(),z=r.getShaderInfoLog(R).trim();let X=!0,I=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(X=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,_,H,R);else{const G=lo(r,H,"vertex"),O=lo(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
FM`,1,5,"osc2_feedback_fm",[0,1,.01]]],o=[on(8,r()),on(8,s())],l=[],c=[],u={};for(const[d,m,g,_,f,p]of a)if(d==="slider"){const[T,S,E,H=Ss,R=Ss]=p,A=pl(m,e,t,n,o[g][_],F=>{i==null||i.sendEventOrValue(f,H(F)),i==null||i.requestParameterValue(f)},0,T,S,E,!1);l.push([A,g,_]),u[f]=[A,R]}else if(d==="radio"){const T=Ir(m,e,n,o[g][_],S=>{i==null||i.sendEventOrValue(f,S),i==null||i.requestParameterValue(f)},0,!0,!1);c.push([T,g,_]),u[f]=[T,Ss]}const h=({endpointID:d,value:m})=>{if(!u[d])return;const[g,_]=u[d];g.setValue(_(m))};i==null||i.addAllParameterListener(h);for(const[d,m,g,_,f,p]of a)i==null||i.requestParameterValue(f);return{resize:()=>{const d=[on(8,r()),on(8,s())];for(const[m,g,_]of l)m.setBoundingBox(d[g][_]);for(const[m,g,_]of c)m.setBoundingBox(d[g][_])},setVisible:d=>{for(const[m]of l)m.setVisible(d);for(const[m]of c)m.setVisible(d)},canvasDraw:()=>{for(const[d]of l)d.draw();for(const[d]of c)d.draw()}}},Lo=(i,e,t,n,r,s=!1)=>{let a=.1,o=.3,l=.7,c=.2,u=[],h=null,d=[],m=!1,g=s;const _=[new St(new P(1,0,0),-n.left),new St(new P(-1,0,0),n.right),new St(new P(0,-1,0),n.top),new St(new P(0,1,0),-n.bottom)],f=new Rn({color:65535,linewidth:3,dashed:!1,transparent:!0,opacity:1,blending:Pn,clippingPlanes:_}),p=new Rn({color:65535,linewidth:3,dashed:!0,gapSize:10,dashSize:10,transparent:!0,opacity:1,blending:Pn,clippingPlanes:_}),T=new $n({color:16711935}),S=()=>{if(u)for(const I of u)e.remove(I),I.geometry.dispose();d.forEach(I=>{e.remove(I),I.geometry.dispose(),I.material.dispose()}),d=[]},E=()=>{if(!m)return;const I=n.right-n.left,G=n.top-n.bottom,O=I/4,$=a*O,ie=o*O,ae=c*O,Ae=I-($+ie+ae),Ue=n.left+$,q=Ue+ie,Q=q+Ae;n.right;const he=n.top,oe=n.bottom+l*G;S();const Ee=new P(n.left,n.bottom,0),De=new P(Ue,he,0),Oe=new P(q,oe,0),$e=new P(Q,oe,0),w=new P(n.right,n.bottom,0),He=g?j=>(1-Math.exp(-3*j))/(1-Math.exp(-3)):j=>j,ge=Math.max(Math.floor(Ee.distanceTo(De)/5)),je=[];for(let j=0;j<=ge;j++){const ce=j/ge,Ie=n.left+ce*$,xe=n.bottom+He(ce)*(he-n.bottom);je.push([Ie,xe,0])}const Te=Math.max(Math.floor(De.distanceTo(Oe)/5)),we=[];for(let j=0;j<=Te;j++){const ce=j/Te,Ie=Ue+ce*ie,xe=he-He(ce)*(he-oe);we.push([Ie,xe,0])}const b=Math.max(Math.floor($e.distanceTo(w)/5)),v=[];for(let j=0;j<=b;j++){const ce=j/b,Ie=Q+ce*ae,xe=oe-He(ce)*(oe-n.bottom);v.push([Ie,xe,0])}const W=new un;W.setPositions(je.flat());const J=new An(W,f);e.add(J),u.push(J);const ee=new un;ee.setPositions(we.flat());const Z=new An(ee,f);e.add(Z),u.push(Z);const ve=new un;ve.setPositions([q,oe,0,Q,oe,0]);const le=new An(ve,p);le.computeLineDistances(),e.add(le),u.push(le);const de=new un;de.setPositions(v.flat());const Re=new An(de,f);e.add(Re),u.push(Re),H([De,Oe,$e])},H=I=>{I.forEach(G=>{const O=new ki(10,32),$=new Tt(O,T);$.position.set(G.x,G.y,0),e.add($),d.push($)})},R=I=>{if(!m)return;const G=B(I);h=L(G)},A=I=>{if(h===null)return;const G=B(I),O=n.right-n.left,$=n.top-n.bottom;switch(h){case 1:F(G.x,O);break;case 2:y(G.x,G.y,O,$);break;case 3:x(G.x,G.y,O,$);break}E()},F=(I,G)=>{const O=G/4;a=Gn.clamp((I-n.left)/O,0,1)},y=(I,G,O,$)=>{const ie=O/4;o=Gn.clamp((I-n.left)/ie-a,0,1),l=Gn.clamp((G-n.bottom)/$,0,1)},x=(I,G,O,$)=>{const ie=O/4;c=Gn.clamp((n.right-I)/ie,0,1),l=Gn.clamp((G-n.bottom)/$,0,1)},C=()=>{h!==null&&(h=null,z())},B=I=>{const G=t.getBoundingClientRect(),O=I.clientX-G.left-window.innerWidth/2,$=window.innerHeight/2-(I.clientY-G.top);return new P(O,$,0)},L=I=>{const G=n.right-n.left,O=n.top-n.bottom,$=G/4,ie=20,ae=n.left+a*$,Ae=ae+o*$,Ue=Ae+(G-a*$-o*$-c*$),q=new P(ae,n.top,0),Q=new P(Ae,n.bottom+l*O,0),he=new P(Ue,n.bottom+l*O,0),oe=[I.distanceTo(q),I.distanceTo(Q),I.distanceTo(he)],Ee=oe.indexOf(Math.min(...oe));return oe[Ee]<=ie?Ee+1:null},z=()=>{i==null||i.sendEventOrValue(`${r}_attack`,a),i==null||i.sendEventOrValue(`${r}_decay`,o),i==null||i.sendEventOrValue(`${r}_sustain`,l),i==null||i.sendEventOrValue(`${r}_release`,c)};window.addEventListener("mousedown",R,!1),window.addEventListener("mousemove",A,!1),window.addEventListener("mouseup",C,!1),E();const X=({endpointID:I,value:G})=>{const $={[`${r}_attack`]:()=>{a=G},[`${r}_decay`]:()=>{o=G},[`${r}_sustain`]:()=>{l=G},[`${r}_release`]:()=>{c=G}}[I];$&&($(),E())};return i==null||i.addAllParameterListener(X),i==null||i.requestParameterValue(`${r}_attack`),i==null||i.requestParameterValue(`${r}_decay`),i==null||i.requestParameterValue(`${r}_sustain`),i==null||i.requestParameterValue(`${r}_release`),{setBoundingBox:I=>{n=I,_[0].set(new P(1,0,0),-n.left),_[1].set(new P(-1,0,0),n.right),_[2].set(new P(0,-1,0),n.top),_[3].set(new P(0,1,0),-n.bottom),E()},setExponential:I=>{g=I,E()},setVisible:I=>{I!=m&&(m=I,m?E():S())}}},Em=(i,e,t,n,r,s)=>{let a=!0;const o=g=>({...g,left:g.left+Pe(148),top:g.top-Pe(56)}),l=g=>({...g,right:g.left+Pe(146),top:g.top-Pe(56)}),c=Lo(i,e,t,o(r()),"adsr1"),u=Lo(i,e,t,o(s()),"adsr2"),h=Ir(["Linear","Exp"],e,n,l(r()),g=>{c.setExponential(!!g)},0,!0,!1),d=Ir(["Linear","Exp"],e,n,l(s()),g=>{u.setExponential(!!g)},0,!0,!1),m=()=>{a&&(Ai(n,r(),"Osc 1 - ADSR"),Ai(n,s(),"Osc 2 - ADSR"))};return{resize:()=>{c.setBoundingBox(o(r())),u.setBoundingBox(o(s())),h.setBoundingBox(l(r())),d.setBoundingBox(l(s()))},setVisible:g=>{a=g,c.setVisible(g),u.setVisible(g),h.setVisible(g),d.setVisible(g)},canvasDraw:()=>{m(),h.draw(),d.draw()}}},Ms=i=>i,Tm=(i,e,t,n,r,s)=>{let a=!1;const o=[["radio",["Off","On"],0,0,"chorus_enabled"],["slider",`
Rate`,0,1,"chorus_rate",[.1,6,.01]],["slider",`
Depth`,0,2,"chorus_depth",[0,1,.01]],["radio",["Off","On"],0,3,"phaser_enabled"],["slider",`
Rate`,0,4,"phaser_rate",[.1,2,.01]],["slider",`
Spread`,0,5,"phaser_spread",[0,1,.01]],["slider",`
Coef`,0,6,"phaser_coef",[.2,.8,.05]],["slider",`
Depth`,0,7,"phaser_depth",[0,1,.01]]],l=[on(8,r()),on(8,s())],c=[],u=[],h={};for(const[g,_,f,p,T,S]of o)if(g==="slider"){const[E,H,R,A=Ms,F=Ms]=S,y=pl(_,e,t,n,l[f][p],x=>{i==null||i.sendEventOrValue(T,A(x)),i==null||i.requestParameterValue(T)},0,E,H,R,!1);c.push([y,f,p]),h[T]=[y,F]}else if(g==="radio"){const E=Ir(_,e,n,l[f][p],H=>{i==null||i.sendEventOrValue(T,H),i==null||i.requestParameterValue(T)},0,!0,!1);u.push([E,f,p]),h[T]=[E,Ms]}const d=({endpointID:g,value:_})=>{if(!h[g])return;const[f,p]=h[g];f.setValue(p(_))};i==null||i.addAllParameterListener(d);for(const[g,_,f,p,T,S]of o)i==null||i.requestParameterValue(T);const m=()=>{if(!a)return;const g=on(8,r());Ai(n,g[0],"Chorus"),Ai(n,g[3],"Phaser")};return{resize:()=>{const g=[on(8,r()),on(8,s())];for(const[_,f,p]of c)_.setBoundingBox(g[f][p]);for(const[_,f,p]of u)_.setBoundingBox(g[f][p])},setVisible:g=>{a=g;for(const[_]of c)_.setVisible(g);for(const[_]of u)_.setVisible(g);m()},canvasDraw:()=>{for(const[g]of c)g.draw();for(const[g]of u)g.draw();m()}}};let pi;const ys={threshold:0,strength:1.5,radius:0},bm=i=>{const e=i.clientWidth,t=i.clientHeight,n=new Gp,r=new fa(e/-2,e/2,t/2,t/-2,1,1e3);r.position.z=2;const s=new Vp({antialias:!0});s.setSize(e,t),s.toneMapping=Io,s.localClippingEnabled=!0,i.appendChild(s.domElement);const a=new Qp(s),o=new em(n,r);a.addPass(o);const l=new bi(new Le(e,t),ys.strength,ys.radius,ys.threshold);return a.addPass(l),ml(a)(),[n,r,s,a]},ml=i=>()=>{requestAnimationFrame(ml(i)),i.render()};document.addEventListener("DOMContentLoaded",()=>{window.frameElement&&window.frameElement.CmajorSingletonPatchConnection?pi=window.frameElement.CmajorSingletonPatchConnection:pi=nm;const i=document.getElementById("root");if(!i)return;const[e,t,n,r]=bm(i),s=document.getElementById("canvas"),a=s.getContext("2d"),o=Mm(pi,e,i,a,_r,vr),l=ym(pi,e,i,a,_r,vr),c=Tm(pi,e,i,a,_r,vr),u=Em(pi,e,i,a,_r,vr),h=lm(s,a,g=>{g===0?o.setVisible(!0):o.setVisible(!1),g===1?l.setVisible(!0):l.setVisible(!1),g===2?u.setVisible(!0):u.setVisible(!1),g===4?c.setVisible(!0):c.setVisible(!1),m()}),d=()=>{const g=i.clientWidth,_=i.clientHeight;t.left=g/-2,t.right=g/2,t.top=_/2,t.bottom=_/-2,t.updateProjectionMatrix(),n.setSize(g,_),r.setSize(g,_),o.resize(),l.resize(),u.resize(),c.resize(),m()},m=()=>{!s||!a||(s.width=window.innerWidth,s.height=window.innerHeight,a.clearRect(0,0,s.width,s.height),h.draw(),o.canvasDraw(),l.canvasDraw(),u.canvasDraw(),c.canvasDraw())};window.addEventListener("resize",d,!1),m(),h.triggerTabUpdate()});
