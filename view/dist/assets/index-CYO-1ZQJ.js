...
FM`,1,5,"osc2_feedback_fm",[0,1,.01]]],a=[vt(8,r()),vt(8,s())],l=[],c=[],u={};for(const[f,m,g,_,d,p]of o)if(f==="slider"){const[T,S,E,B=Ms,C=Ms]=p,A=Zn(m,e,t,n,a[g][_],F=>{i==null||i.sendEventOrValue(d,B(F)),i==null||i.requestParameterValue(d)},0,T,S,E,!1);l.push([A,g,_]),u[d]=[A,C]}else if(f==="radio"){const T=Qn(m,e,n,a[g][_],S=>{i==null||i.sendEventOrValue(d,S),i==null||i.requestParameterValue(d)},0,!0,!1);c.push([T,g,_]),u[d]=[T,Ms]}const h=({endpointID:f,value:m})=>{if(!u[f])return;const[g,_]=u[f];g.setValue(_(m))};i==null||i.addAllParameterListener(h);for(const[f,m,g,_,d,p]of o)i==null||i.requestParameterValue(d);return{resize:()=>{const f=[vt(8,r()),vt(8,s())];for(const[m,g,_]of l)m.setBoundingBox(f[g][_]);for(const[m,g,_]of c)m.setBoundingBox(f[g][_])},setVisible:f=>{for(const[m]of l)m.setVisible(f);for(const[m]of c)m.setVisible(f)},canvasDraw:()=>{for(const[f]of l)f.draw();for(const[f]of c)f.draw()}}},sa=(i,e,t,n,r,s=!1)=>{let o=.1,a=.3,l=.7,c=.2,u=[],h=null,f=[],m=!1,g=s;const _=[new Mt(new P(1,0,0),-n.left),new Mt(new P(-1,0,0),n.right),new Mt(new P(0,-1,0),n.top),new Mt(new P(0,1,0),-n.bottom)],d=new Cn({color:65535,linewidth:3,dashed:!1,transparent:!0,opacity:1,blending:Ln,clippingPlanes:_}),p=new Cn({color:65535,linewidth:3,dashed:!0,gapSize:10,dashSize:10,transparent:!0,opacity:1,blending:Ln,clippingPlanes:_}),T=new Jn({color:16711935}),S=()=>{if(u)for(const I of u)e.remove(I),I.geometry.dispose();f.forEach(I=>{e.remove(I),I.geometry.dispose(),I.material.dispose()}),f=[]},E=()=>{if(!m)return;const I=n.right-n.left,G=n.top-n.bottom,O=I/4,$=o*O,ie=a*O,ae=c*O,we=I-($+ie+ae),Ue=n.left+$,q=Ue+ie,Q=q+we;n.right;const he=n.top,oe=n.bottom+l*G;S();const Te=new P(n.left,n.bottom,0),De=new P(Ue,he,0),Oe=new P(q,oe,0),$e=new P(Q,oe,0),w=new P(n.right,n.bottom,0),Ve=g?j=>(1-Math.exp(-3*j))/(1-Math.exp(-3)):j=>j,ge=Math.max(Math.floor(Te.distanceTo(De)/5)),je=[];for(let j=0;j<=ge;j++){const ce=j/ge,Ie=n.left+ce*$,xe=n.bottom+Ve(ce)*(he-n.bottom);je.push([Ie,xe,0])}const be=Math.max(Math.floor(De.distanceTo(Oe)/5)),Re=[];for(let j=0;j<=be;j++){const ce=j/be,Ie=Ue+ce*ie,xe=he-Ve(ce)*(he-oe);Re.push([Ie,xe,0])}const b=Math.max(Math.floor($e.distanceTo(w)/5)),x=[];for(let j=0;j<=b;j++){const ce=j/b,Ie=Q+ce*ae,xe=oe-Ve(ce)*(oe-n.bottom);x.push([Ie,xe,0])}const W=new hn;W.setPositions(je.flat());const J=new wn(W,d);e.add(J),u.push(J);const ee=new hn;ee.setPositions(Re.flat());const Z=new wn(ee,d);e.add(Z),u.push(Z);const ve=new hn;ve.setPositions([q,oe,0,Q,oe,0]);const le=new wn(ve,p);le.computeLineDistances(),e.add(le),u.push(le);const de=new hn;de.setPositions(x.flat());const Ce=new wn(de,d);e.add(Ce),u.push(Ce),B([De,Oe,$e])},B=I=>{I.forEach(G=>{const O=new Yi(10,32),$=new bt(O,T);$.position.set(G.x,G.y,0),e.add($),f.push($)})},C=I=>{if(!m)return;const G=z(I);h=L(G)},A=I=>{if(h===null)return;const G=z(I),O=n.right-n.left,$=n.top-n.bottom;switch(h){case 1:F(G.x,O);break;case 2:y(G.x,G.y,O,$);break;case 3:v(G.x,G.y,O,$);break}E()},F=(I,G)=>{const O=G/4;o=Wn.clamp((I-n.left)/O,0,1)},y=(I,G,O,$)=>{const ie=O/4;a=Wn.clamp((I-n.left)/ie-o,0,1),l=Wn.clamp((G-n.bottom)/$,0,1)},v=(I,G,O,$)=>{const ie=O/4;c=Wn.clamp((n.right-I)/ie,0,1),l=Wn.clamp((G-n.bottom)/$,0,1)},R=()=>{h!==null&&(h=null,V())},z=I=>{const G=t.getBoundingClientRect(),O=I.clientX-G.left-window.innerWidth/2,$=window.innerHeight/2-(I.clientY-G.top);return new P(O,$,0)},L=I=>{const G=n.right-n.left,O=n.top-n.bottom,$=G/4,ie=20,ae=n.left+o*$,we=ae+a*$,Ue=we+(G-o*$-a*$-c*$),q=new P(ae,n.top,0),Q=new P(we,n.bottom+l*O,0),he=new P(Ue,n.bottom+l*O,0),oe=[I.distanceTo(q),I.distanceTo(Q),I.distanceTo(he)],Te=oe.indexOf(Math.min(...oe));return oe[Te]<=ie?Te+1:null},V=()=>{i==null||i.sendEventOrValue(`${r}_attack`,o),i==null||i.sendEventOrValue(`${r}_decay`,a),i==null||i.sendEventOrValue(`${r}_sustain`,l),i==null||i.sendEventOrValue(`${r}_release`,c)};window.addEventListener("mousedown",C,!1),window.addEventListener("mousemove",A,!1),window.addEventListener("mouseup",R,!1),E();const X=({endpointID:I,value:G})=>{const $={[`${r}_attack`]:()=>{o=G},[`${r}_decay`]:()=>{a=G},[`${r}_sustain`]:()=>{l=G},[`${r}_release`]:()=>{c=G}}[I];$&&($(),E())};return i==null||i.addAllParameterListener(X),i==null||i.requestParameterValue(`${r}_attack`),i==null||i.requestParameterValue(`${r}_decay`),i==null||i.requestParameterValue(`${r}_sustain`),i==null||i.requestParameterValue(`${r}_release`),{setBoundingBox:I=>{n=I,_[0].set(new P(1,0,0),-n.left),_[1].set(new P(-1,0,0),n.right),_[2].set(new P(0,-1,0),n.top),_[3].set(new P(0,1,0),-n.bottom),E()},setExponential:I=>{g=I,E()},setVisible:I=>{I!=m&&(m=I,m?E():S())}}},Tm=(i,e,t,n,r,s)=>{let o=!0;const a=_=>({..._,left:_.left+Ee(148),top:_.top-Ee(56)}),l=_=>({..._,right:_.left+Ee(146),top:_.top-Ee(56)}),c=sa(i,e,t,a(r()),"adsr1"),u=sa(i,e,t,a(s()),"adsr2"),h=Qn(["Linear","Exp"],e,n,l(r()),_=>{i==null||i.sendEventOrValue("adsr1_mode",_),i==null||i.requestParameterValue("adsr1_mode")},0,!0,!1),f=Qn(["Linear","Exp"],e,n,l(s()),_=>{i==null||i.sendEventOrValue("adsr2_mode",_),i==null||i.requestParameterValue("adsr2_mode")},0,!0,!1),m=({endpointID:_,value:d})=>{_=="adsr1_mode"&&(h.setValue(d),c.setExponential(!!d)),_=="adsr2_mode"&&(f.setValue(d),u.setExponential(!!d))};i==null||i.addAllParameterListener(m),i==null||i.requestParameterValue("adsr1_mode"),i==null||i.requestParameterValue("adsr2_mode");const g=()=>{o&&(Qt(n,r(),"Osc 1 - ADSR"),Qt(n,s(),"Osc 2 - ADSR"))};return{resize:()=>{c.setBoundingBox(a(r())),u.setBoundingBox(a(s())),h.setBoundingBox(l(r())),f.setBoundingBox(l(s()))},setVisible:_=>{o=_,c.setVisible(_),u.setVisible(_),h.setVisible(_),f.setVisible(_)},canvasDraw:()=>{g(),h.draw(),f.draw()}}},ys=i=>i,bm=(i,e,t,n,r,s)=>{let o=!1;const a=[["radio",["Off","On"],0,0,"chorus_enabled"],["slider",`
...
Depth`,0,7,"phaser_depth",[0,1,.01]]],l=[vt(8,r()),vt(8,s())],c=[],u=[],h={};for(const[g,_,d,p,T,S]of a)if(g==="slider"){const[E,B,C,A=ys,F=ys]=S,y=Zn(_,e,t,n,l[d][p],v=>{i==null||i.sendEventOrValue(T,A(v)),i==null||i.requestParameterValue(T)},0,E,B,C,!1);c.push([y,d,p]),h[T]=[y,F]}else if(g==="radio"){const E=Qn(_,e,n,l[d][p],B=>{i==null||i.sendEventOrValue(T,B),i==null||i.requestParameterValue(T)},0,!0,!1);u.push([E,d,p]),h[T]=[E,ys]}const f=({endpointID:g,value:_})=>{if(!h[g])return;const[d,p]=h[g];d.setValue(p(_))};i==null||i.addAllParameterListener(f);for(const[g,_,d,p,T,S]of a)i==null||i.requestParameterValue(T);const m=()=>{if(!o)return;const g=vt(8,r());Qt(n,g[0],"Chorus"),Qt(n,g[3],"Phaser")};return{resize:()=>{const g=[vt(8,r()),vt(8,s())];for(const[_,d,p]of c)_.setBoundingBox(g[d][p]);for(const[_,d,p]of u)_.setBoundingBox(g[d][p])},setVisible:g=>{o=g;for(const[_]of c)_.setVisible(g);for(const[_]of u)_.setVisible(g);m()},canvasDraw:()=>{for(const[g]of c)g.draw();for(const[g]of u)g.draw();m()}}},Uo=(i,e,t,n,r,s)=>{let o=!1,a=!0,l={type:0,cutoff:0,resonance:0,keytracking:0};const c=vt(4,n),u=Qn(["Off","LP"],i,t,c[0],d=>{s({...l,type:d})},0,!0,!1),h=Zn(`
KeyTrack`,i,e,t,c[1],d=>{s({...l,keytracking:d})},0,0,1,.01,!1),f=Zn(`
Cutoff`,i,e,t,c[2],d=>{s({...l,cutoff:d})},0,0,1,.01,!1),m=Zn(`
Reso`,i,e,t,c[3],d=>{s({...l,resonance:d})},0,0,1,.01,!1),g=()=>{u.setVisible(o),h.setVisible(o),f.setVisible(o),m.setVisible(o&&a),r()},_=d=>{a=d==1,g()};return{setBoundingBox:d=>{const p=vt(4,d);u.setBoundingBox(p[0]),h.setBoundingBox(p[1]),f.setBoundingBox(p[2]),m.setBoundingBox(p[3])},setVisible:d=>{o=d,g()},canvasDraw:()=>{u.draw(),h.draw(),f.draw(),m.draw()},setValue:d=>{l=d,_(l.type)}}},Am=(i,e,t,n,r,s,o)=>{let a=!0,l=!1,c=!1,u=!1;const h=vt(2,r()),f=vt(8,s()),m=v=>{const R=s();return{...v,top:v.top-Ee(56),left:v.left+Ee(8),right:R.right-Ee(240)}},g=v=>({...v,left:v.right-Ee(220)}),_=Uo(e,t,n,h[0],o,v=>{console.log(v)}),d=Uo(e,t,n,h[1],o,v=>{console.log(v)}),p=sa(i,e,t,m(f[2]),"adsr1"),T=Qn(["None","LFO","ADSR L","ADSR E","OSC 1","OSC 2"],e,n,f[0],v=>{A(v)},0,!0,!1),S=Zn(`
Depth`,e,t,n,f[1],v=>{},0,0,1,.01,!1),E=Zn(`
Rate`,e,t,n,f[2],v=>{},0,0,1,.01,!1),B=Qn(["Parallel","Series 1 → 2","Series 2 → 1"],e,n,g(s()),v=>{},0,!0,!1),C=()=>{_.setVisible(a),d.setVisible(a),T.setVisible(a),S.setVisible(a&&c),E.setVisible(a&&u),p.setVisible(a&&l),B.setVisible(a),o()},A=v=>{l=v==2||v==3,c=v!=0,u=v==1,C(),p.setExponential(v==3)},F=({endpointID:v,value:R})=>{};i==null||i.addAllParameterListener(F);const y=()=>{if(!a)return;const v=vt(2,r());Qt(n,v[0],"Filter A"),Qt(n,v[1],"Filter B"),Qt(n,s(),"Filter A Mod"),Qt(n,g(s()),"Filter Routing")};return{resize:()=>{const v=vt(2,r());_.setBoundingBox(v[0]),d.setBoundingBox(v[1]);const R=vt(8,s());p.setBoundingBox(m(R[2])),S.setBoundingBox(R[1]),E.setBoundingBox(R[2]),T.setBoundingBox(R[0]),B.setBoundingBox(g(s()))},setVisible:v=>{a=v,C()},canvasDraw:()=>{y(),_.canvasDraw(),d.canvasDraw(),T.draw(),S.draw(),E.draw(),B.draw()}}};let Hn;const Es={threshold:0,strength:1.5,radius:0},wm=i=>{const e=i.clientWidth,t=i.clientHeight,n=new kp,r=new ma(e/-2,e/2,t/2,t/-2,1,1e3);r.position.z=2;const s=new Gp({antialias:!0});s.setSize(e,t),s.toneMapping=Fo,s.localClippingEnabled=!0,i.appendChild(s.domElement);const o=new em(s),a=new tm(n,r);o.addPass(a);const l=new Ri(new Le(e,t),Es.strength,Es.radius,Es.threshold);return o.addPass(l),gl(o)(),[n,r,s,o]},gl=i=>()=>{requestAnimationFrame(gl(i)),i.render()};document.addEventListener("DOMContentLoaded",()=>{window.frameElement&&window.frameElement.CmajorSingletonPatchConnection?Hn=window.frameElement.CmajorSingletonPatchConnection:Hn=im;const i=document.getElementById("root");if(!i)return;const[e,t,n,r]=wm(i),s=document.getElementById("canvas"),o=s.getContext("2d"),a=ym(Hn,e,i,o,Fi,Oi),l=Em(Hn,e,i,o,Fi,Oi),c=bm(Hn,e,i,o,Fi,Oi),u=Tm(Hn,e,i,o,Fi,Oi),h=Am(Hn,e,i,o,Fi,Oi,()=>{g()}),f=cm(s,o,_=>{_===0?a.setVisible(!0):a.setVisible(!1),_===1?l.setVisible(!0):l.setVisible(!1),_===2?u.setVisible(!0):u.setVisible(!1),_===3?h.setVisible(!0):h.setVisible(!1),_===4?c.setVisible(!0):c.setVisible(!1),g()}),m=()=>{const _=i.clientWidth,d=i.clientHeight;t.left=_/-2,t.right=_/2,t.top=d/2,t.bottom=d/-2,t.updateProjectionMatrix(),n.setSize(_,d),r.setSize(_,d),a.resize(),l.resize(),u.resize(),h.resize(),c.resize(),g()},g=()=>{!s||!o||(s.width=window.innerWidth,s.height=window.innerHeight,o.clearRect(0,0,s.width,s.height),f.draw(),a.canvasDraw(),l.canvasDraw(),u.canvasDraw(),h.canvasDraw(),c.canvasDraw())};window.addEventListener("resize",m,!1),g(),f.triggerTabUpdate()});
