...
`)+`
`+p);const S=T+f+a,E=T+p+o,V=oo(r,r.VERTEX_SHADER,S),R=oo(r,r.FRAGMENT_SHADER,E);r.attachShader(_,V),r.attachShader(_,R),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function b(C){if(i.debug.checkShaderErrors){const B=r.getProgramInfoLog(_).trim(),L=r.getShaderInfoLog(V).trim(),z=r.getShaderInfoLog(R).trim();let X=!0,I=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(X=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,_,V,R);else{const G=lo(r,V,"vertex"),O=lo(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
